                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      Text("Temperature",style: TextStyle(color: Colors.black,fontSize: 18)),
                        SizedBox(height: 5,),
                      Text("celsius",style: TextStyle(color: Colors.blue,fontSize: 14)),
                      Divider(thickness: 2,),
                        SizedBox(height: 10,),
                      Text("wind",style: TextStyle(color: Colors.black,fontSize: 18)),
                        SizedBox(height: 5,),
                      Text("Kilometers per Hour (km/h)",style: TextStyle(color: Colors.blue,fontSize: 14)),
                      Divider(thickness: 2,),
                        SizedBox(height: 10,),
                        Text("Air pressure",style: TextStyle(color: Colors.black,fontSize: 18)),
                          SizedBox(height: 5,),
                        Text("Hectopascals (hPa)",style: TextStyle(color: Colors.blue,fontSize: 14)),
                        Divider(thickness: 2,),
                               SizedBox(height: 10,),
                        Text("visibility",style: TextStyle(color: Colors.black,fontSize: 18)),
                               SizedBox(height: 5,),
                         Text("Kilometers (Km)",style: TextStyle(color: Colors.blue,fontSize: 14)),
                                SizedBox(height: 10,),
                    ],
                  ),
